    ...
    <div className="bg-warm-white min-h-screen">
      ...
      <section className="min-h-screen grid md:grid-cols-2 pt-20 relative overflow-hidden">
        ...
        <div className="flex flex-col justify-center px-12 py-20 relative z-10">
          ...
          <h1 className="font-serif text-[clamp(3rem,5vw,5rem)] font-light leading-[1.05] tracking-[-0.02em] text-deep-brown mb-6 animate-fade-up delay-200">
      ...
      {/* ── STATS BAR ───────────────────────────────────────── */}
      <div className="bg-deep-brown px-12 py-10 flex justify-around flex-wrap gap-8">
      ...
      {/* ── HOW IT WORKS ────────────────────────────────────── */}
      <section className="px-12 py-28" id="how">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-[rgba(60,42,20,0.12)]">
          {[
            ...
            <div key={s.n} className="bg-warm-white p-12 relative overflow-hidden group">
      ...
      {/* ── FOR MEMBERS ─────────────────────────────────────── */}
      <section className="px-12 py-24 bg-cream relative overflow-hidden" id="members">
      ...
      {/* ── AUDIENCE CARDS ──────────────────────────────────── */}
      <section className="px-12 py-24" id="businesses">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={a.title} className={`${a.bg} p-10 rounded-[4px] border border-[rgba(60,42,20,0.1)] flex flex-col`}>
      ...
      {/* ── CHURCHES ────────────────────────────────────────── */}
      <section className="px-12 py-24 bg-deep-brown relative overflow-hidden" id="churches">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/[0.08]">
          {[["R","Redeemed CC","Lagos Mainland"],["H","House on the Rock","Victoria Island"],["D","Daystar","Oregun, Lagos"],["C","Chapel of Grace","Abuja"],["W","Winners Chapel","Port Harcourt"],["L","Lighthouse","Ibadan"],["M","Mountain of Fire","Enugu"],["+","Your Branch","Register today →"]].map(([l,n,loc])=>(
            <div key={n} className="bg-deep-brown hover:bg-amber/10 transition-colors p-8 text-center">
      ...
      {/* ── CTA ─────────────────────────────────────────────── */}
      <section className="px-12 py-36 text-center relative overflow-hidden">
      ...
      {/* ── FOOTER ──────────────────────────────────────────── */}
      <footer className="bg-deep-brown px-12 pt-16 pb-8">
        <div className="grid md:grid-cols-4 gap-12 pb-12 border-b border-white/[0.06] mb-8">
          <div>
        ...
        <div className="flex justify-between text-[0.72rem] text-white/25">
