  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard number="12"  label="New This Week"    icon="✦" colorClass="text-forest"     />
        <StatCard number="6"   label="Pending Approval" icon="⌛" colorClass="text-terra"      />
        <StatCard number="3"   label="Announcements"    icon="📢" colorClass="text-sky"        />
      </div>
      <div className="grid lg:grid-cols-[1fr_300px] gap-6">
        <div>
          <h2 className="font-serif text-[1.3rem] font-semibold mb-4">Skills Distribution</h2>
          <Card className="mb-6">
            {[["Technology",68,"bg-amber"],["Finance",42,"bg-forest"],["Creative",35,"bg-terra"],["Education",28,"bg-sky"],["Healthcare",22,"bg-muted"]].map(([l,v,c])=>(
          ...
          <div className="space-y-2">
            {[{n:"Chidera Okafor",s:"Technology",date:"Today",c:"bg-amber"},{n:"Emeka Tunde",s:"Finance",date:"Yesterday",c:"bg-forest"},{n:"Blessing Adeyemi",s:"Design",date:"2 days ago",c:"bg-terra"}].map(m=>(
